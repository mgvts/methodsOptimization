...
if __name__ == '__main__':
    ...
    b1 = LinearRegression(X, Y, b, count / 2).stochastic_grad_down_exponential_points(alpha=0.0003, c=-0.001, runs=100000, eps = 0.0001)
    print(len(b1))
    ...
    plt.title(f"Start point=(10, 10), Minibatch CD with exp={len(b1)}, Minibatch CD={len(b2)}")
    plt.plot(x1, y1, 'o-r', alpha=1, label="Minibatch CD with exp", lw=0.5, mec='b', mew=1, ms=1)
